        ...
        private static ArrangeMetadataElement FirmAssociatedPositionMustHavePrincipalWithMatchedBindingObject
            => ArrangeMetadataElement
                ...
                .Aggregate(
                    ...
                    new Firm.FirmPosition { FirmId = 2, OrderPositionId = 4, Start = MonthStart(1), End = MonthStart(2), PackagePositionId = 2, ItemPositionId = 3, Category1Id = 1, Category3Id = 3 },
                    new Firm.FirmPosition { FirmId = 2, OrderPositionId = 5, Start = MonthStart(1), End = MonthStart(2), PackagePositionId = 2, ItemPositionId = 3, Category1Id = 1, Category3Id = 2 },
                    ...
                    new Firm { Id = 3 },
                    new Firm.FirmPosition { FirmId = 3, OrderPositionId = 6, Start = MonthStart(1), End = MonthStart(2), PackagePositionId = 2, ItemPositionId = 2, Category1Id = 1, Category3Id = 2 },
                    new Firm.FirmPosition { FirmId = 3, OrderPositionId = 7, Start = MonthStart(1), End = MonthStart(2), PackagePositionId = 2, ItemPositionId = 3, Category1Id = 1, Category3Id = 3 },
                    new Firm.FirmPosition { FirmId = 3, OrderPositionId = 8, Start = MonthStart(1), End = MonthStart(2), PackagePositionId = 2, ItemPositionId = 4 },
                    ...
                    new Firm { Id = 4 },
                    new Firm.FirmPosition { FirmId = 4, OrderPositionId =  9, Start = MonthStart(1), End = MonthStart(2), PackagePositionId = 2, ItemPositionId = 2, Category1Id = 1, Category3Id = 2 },
                    new Firm.FirmPosition { FirmId = 4, OrderPositionId = 10, Start = MonthStart(1), End = MonthStart(2), PackagePositionId = 2, ItemPositionId = 2, Category1Id = 1, Category3Id = 3 },
                    new Firm.FirmPosition { FirmId = 4, OrderPositionId = 11, Start = MonthStart(1), End = MonthStart(2), PackagePositionId = 2, ItemPositionId = 3, Category1Id = 1, Category3Id = 2 },
