        ...
        private static ArrangeMetadataElement FirmAssociatedPositionMustHavePrincipalWithDifferentBindingObject
            => ArrangeMetadataElement
                ...
                .Aggregate(
                    ...
                    new Firm.FirmPosition { FirmId = 2, OrderPositionId = 4, Begin = MonthStart(1), End = MonthStart(2), PackagePositionId = 3, ItemPositionId = 3, Category1Id = 1, Category3Id = 2 },
                    ...
                    new Firm { Id = 3 },
                    new Firm.FirmPosition { FirmId = 3, OrderPositionId = 5, Begin = MonthStart(1), End = MonthStart(2), PackagePositionId = 2, ItemPositionId = 2, Category1Id = 1, Category3Id = 2 },
                    ...
                    new Firm { Id = 4 },
                    new Firm.FirmPosition { FirmId = 4, OrderPositionId = 6, Begin = MonthStart(1), End = MonthStart(2), PackagePositionId = 2, ItemPositionId = 2, Category1Id = 1, Category3Id = 2 },
                    new Firm.FirmPosition { FirmId = 4, OrderPositionId = 7, Begin = MonthStart(1), End = MonthStart(2), PackagePositionId = 3, ItemPositionId = 3, Category1Id = 1, Category3Id = 2 },
                    new Firm.FirmPosition { FirmId = 4, OrderPositionId = 8, Begin = MonthStart(1), End = MonthStart(2), PackagePositionId = 3, ItemPositionId = 3, Category1Id = 1, Category3Id = 3 },
                    ...
                    new Firm { Id = 5 },
                    new Firm.FirmPosition { FirmId = 5, OrderPositionId =  9, Begin = MonthStart(1), End = MonthStart(2), PackagePositionId = 2, ItemPositionId = 2, Category1Id = 1, Category3Id = 2 },
                    new Firm.FirmPosition { FirmId = 5, OrderPositionId = 10, Begin = MonthStart(1), End = MonthStart(2), PackagePositionId = 3, ItemPositionId = 3, Category1Id = 1, Category3Id = 2 },
                    new Firm.FirmPosition { FirmId = 5, OrderPositionId = 11, Begin = MonthStart(1), End = MonthStart(2), PackagePositionId = 4, ItemPositionId = 4 },
