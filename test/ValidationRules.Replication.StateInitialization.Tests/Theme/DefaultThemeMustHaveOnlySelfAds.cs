    ...
    public sealed partial class TestCaseMetadataSource
    {
        ...
        private static ArrangeMetadataElement DefaultThemeMustHaveOnlySelfAdsPositive
            => ArrangeMetadataElement
                ...
                .Fact(
                    new Facts::Order { Id = 1, ProjectId = 3, AgileDistributionStartDate = FirstDayJan, AgileDistributionEndFactDate = FirstDayFeb, IsSelfAds = false },
                ...
                .Aggregate(
                    new Order { Id = 1, ProjectId = 3, Start = FirstDayJan, End = FirstDayFeb, IsSelfAds = false },
