        ...
        private static ArrangeMetadataElement BillsSumShouldMatchOrder
            => ArrangeMetadataElement
                ...
                .Fact(
                    ...
                    new Facts::Order { Id = 1, AgileDistributionStartDate = MonthStart(1), AgileDistributionEndPlanDate = MonthStart(2), LegalPersonId = 1, BranchOfficeOrganizationUnitId = 1, WorkflowStep = Facts::Order.State.OnRegistration },
                    ...
                    new Facts::Order { Id = 2, AgileDistributionStartDate = MonthStart(1), AgileDistributionEndPlanDate = MonthStart(2), LegalPersonId = 1, BranchOfficeOrganizationUnitId = 1, WorkflowStep = Facts::Order.State.OnRegistration },
                    ...
                    // Заказ без счетов
                    new Facts::Order { Id = 3, AgileDistributionStartDate = MonthStart(1), AgileDistributionEndPlanDate = MonthStart(2), LegalPersonId = 1, BranchOfficeOrganizationUnitId = 1, WorkflowStep = Facts::Order.State.OnRegistration },
                    ...
                    new Facts::Order { Id = 4, AgileDistributionStartDate = MonthStart(1), AgileDistributionEndPlanDate = MonthStart(2), LegalPersonId = 1, BranchOfficeOrganizationUnitId = 1, WorkflowStep = Facts::Order.State.OnRegistration, IsFreeOfCharge = true },
