...
namespace NuClear.ValidationRules.Querying.Host.Controllers
{
    ...
    public class PrereleaseController : ApiController
    {
        ...
        public PrereleaseController(VersioningService versioningService, ValidationResultRepositiory repository, ValidationResultFactory factory, CheckModeDescriptorFactory descriptorFactory)
        {
